...
func (in *RKE2ControlPlaneStatus) DeepCopyInto(out *RKE2ControlPlaneStatus) {
	*out = *in
	...
	if in.V1Beta2 != nil {
		...
		*out = new(RKE2ControlPlaneV1Beta2Status)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RKE2ControlPlaneV1Beta2Status) DeepCopyInto(out *RKE2ControlPlaneV1Beta2Status) {
	*out = *in
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RKE2ControlPlaneV1Beta2Status.
func (in *RKE2ControlPlaneV1Beta2Status) DeepCopy() *RKE2ControlPlaneV1Beta2Status {
	if in == nil {
		return nil
	}
	out := new(RKE2ControlPlaneV1Beta2Status)
