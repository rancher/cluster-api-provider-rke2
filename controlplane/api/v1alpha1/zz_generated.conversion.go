...
import (
	...
	apiv1beta1 "github.com/rancher-sandbox/cluster-api-provider-rke2/bootstrap/api/v1beta1"
	v1beta1 "github.com/rancher-sandbox/cluster-api-provider-rke2/controlplane/api/v1beta1"
...
func autoConvert_v1alpha1_EtcdConfig_To_v1beta1_EtcdConfig(in *EtcdConfig, out *v1beta1.EtcdConfig, s conversion.Scope) error {
	...
	if in.CustomConfig != nil {
		...
		*out = new(apiv1beta1.ComponentConfig)
		if err := apiv1alpha1.Convert_v1alpha1_ComponentConfig_To_v1beta1_ComponentConfig(*in, *out, s); err != nil {
			return err
		}
	} else {
...
func autoConvert_v1beta1_EtcdConfig_To_v1alpha1_EtcdConfig(in *v1beta1.EtcdConfig, out *EtcdConfig, s conversion.Scope) error {
	...
	if in.CustomConfig != nil {
		...
		*out = new(apiv1alpha1.ComponentConfig)
		if err := apiv1alpha1.Convert_v1beta1_ComponentConfig_To_v1alpha1_ComponentConfig(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.CustomConfig = nil
...
func autoConvert_v1alpha1_RKE2ControlPlaneSpec_To_v1beta1_RKE2ControlPlaneSpec(in *RKE2ControlPlaneSpec, out *v1beta1.RKE2ControlPlaneSpec, s conversion.Scope) error {
	if err := apiv1alpha1.Convert_v1alpha1_RKE2ConfigSpec_To_v1beta1_RKE2ConfigSpec(&in.RKE2ConfigSpec, &out.RKE2ConfigSpec, s); err != nil {
		return err
	}
...
func autoConvert_v1beta1_RKE2ControlPlaneSpec_To_v1alpha1_RKE2ControlPlaneSpec(in *v1beta1.RKE2ControlPlaneSpec, out *RKE2ControlPlaneSpec, s conversion.Scope) error {
	if err := apiv1alpha1.Convert_v1beta1_RKE2ConfigSpec_To_v1alpha1_RKE2ConfigSpec(&in.RKE2ConfigSpec, &out.RKE2ConfigSpec, s); err != nil {
		return err
	}
	out.Replicas = (*int32)(unsafe.Pointer(in.Replicas))
