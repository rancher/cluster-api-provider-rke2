...
// InitFlags wires the command-line flags consumed by the extension manager.
...
func main() {
	...
	if err := flag.Set("legacy_stderr_threshold_behavior", "false"); err != nil {
		fmt.Fprintf(os.Stderr, "Failed to set klog flag: %v\n", err)
	}
	...
	setupLog.Info("Starting CAPRKE2 extension manager")
