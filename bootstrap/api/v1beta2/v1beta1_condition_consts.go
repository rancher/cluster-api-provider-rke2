...
// Conditions and condition Reasons for the RKE2Config object.
...
const (
	...
	// the RKE2Config controller ensure this pre-condition is satisfied.
	WaitingForClusterInfrastructureV1Beta1Reason = "WaitingForClusterInfrastructure"

	// DataSecretGenerationFailedV1Beta1Reason (Severity=Warning) documents a RKE2Config controller detecting
...
const (
	...
	//
	// NOTE: Cluster certificates are generated only for the RKE2Config object linked to the initial control plane
	...
	// CertificatesGenerationFailedV1Beta1Reason (Severity=Warning) documents a RKE2Config controller detecting
	...
	// CertificatesCorruptedV1Beta1Reason (Severity=Error) documents a RKE2Config controller detecting
