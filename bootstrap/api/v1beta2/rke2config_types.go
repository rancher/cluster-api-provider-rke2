...
type RKE2ConfigSpec struct {
	...
	//+optional
	AgentConfig RKE2AgentConfig `json:"agentConfig,omitzero"`

	// PrivateRegistriesConfig defines the containerd configuration for private registries and local registry mirrors.
	//+optional
	PrivateRegistriesConfig Registry `json:"privateRegistriesConfig,omitzero"`
...
type RKE2AgentConfig struct {
	...
	//+optional
	AdditionalUserData AdditionalUserData `json:"additionalUserData,omitzero"`
}
...
type RegistryConfig struct {
	...
	//+optional
	AuthSecret corev1.ObjectReference `json:"authSecret,omitzero"`
...
type TLSConfig struct {
	...
	// +optional
	TLSConfigSecret corev1.ObjectReference `json:"tlsConfigSecret,omitzero"`
