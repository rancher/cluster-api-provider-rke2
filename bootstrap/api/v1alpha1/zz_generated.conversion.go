...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ConfigMapFileSource)(nil), (*v1beta1.ConfigMapFileSource)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ConfigMapFileSource_To_v1beta1_ConfigMapFileSource(a.(*ConfigMapFileSource), b.(*v1beta1.ConfigMapFileSource), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1beta1.ConfigMapFileSource)(nil), (*ConfigMapFileSource)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_ConfigMapFileSource_To_v1alpha1_ConfigMapFileSource(a.(*v1beta1.ConfigMapFileSource), b.(*ConfigMapFileSource), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ConfigMapFileSource_To_v1beta1_ConfigMapFileSource(in *ConfigMapFileSource, out *v1beta1.ConfigMapFileSource, s conversion.Scope) error {
	out.Name = in.Name
	out.Key = in.Key
	return nil
}

// Convert_v1alpha1_ConfigMapFileSource_To_v1beta1_ConfigMapFileSource is an autogenerated conversion function.
func Convert_v1alpha1_ConfigMapFileSource_To_v1beta1_ConfigMapFileSource(in *ConfigMapFileSource, out *v1beta1.ConfigMapFileSource, s conversion.Scope) error {
	return autoConvert_v1alpha1_ConfigMapFileSource_To_v1beta1_ConfigMapFileSource(in, out, s)
}

func autoConvert_v1beta1_ConfigMapFileSource_To_v1alpha1_ConfigMapFileSource(in *v1beta1.ConfigMapFileSource, out *ConfigMapFileSource, s conversion.Scope) error {
	out.Name = in.Name
	out.Key = in.Key
	return nil
}

// Convert_v1beta1_ConfigMapFileSource_To_v1alpha1_ConfigMapFileSource is an autogenerated conversion function.
func Convert_v1beta1_ConfigMapFileSource_To_v1alpha1_ConfigMapFileSource(in *v1beta1.ConfigMapFileSource, out *ConfigMapFileSource, s conversion.Scope) error {
	return autoConvert_v1beta1_ConfigMapFileSource_To_v1alpha1_ConfigMapFileSource(in, out, s)
}
...
func autoConvert_v1alpha1_FileSource_To_v1beta1_FileSource(in *FileSource, out *v1beta1.FileSource, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_ConfigMapFileSource_To_v1beta1_ConfigMapFileSource(&in.ConfigMap, &out.ConfigMap, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_v1beta1_FileSource_To_v1alpha1_FileSource(in *v1beta1.FileSource, out *FileSource, s conversion.Scope) error {
	...
	if err := Convert_v1beta1_ConfigMapFileSource_To_v1alpha1_ConfigMapFileSource(&in.ConfigMap, &out.ConfigMap, s); err != nil {
		return err
	}
	return nil
}
