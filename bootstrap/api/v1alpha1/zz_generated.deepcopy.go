...
func (in *RKE2AgentConfig) DeepCopyInto(out *RKE2AgentConfig) {
	*out = *in
	in.RKE2CommonNodeConfig.DeepCopyInto(&out.RKE2CommonNodeConfig)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RKE2CommonNodeConfig) DeepCopyInto(out *RKE2CommonNodeConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RKE2CommonNodeConfig.
func (in *RKE2CommonNodeConfig) DeepCopy() *RKE2CommonNodeConfig {
	if in == nil {
		return nil
	}
	out := new(RKE2CommonNodeConfig)
	in.DeepCopyInto(out)
	return out
}
