...
This directory contains the scripts and configuration files to build the images used by the RKE2 CAPI provider. It relies on the [packer](https://developer.hashicorp.com/packer) tool to build the images.
...
- Your AWS account must have the following permissions: https://developer.hashicorp.com/packer/integrations/hashicorp/amazon#iam-task-or-instance-role
