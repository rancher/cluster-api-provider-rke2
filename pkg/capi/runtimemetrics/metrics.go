...
// Package runtimemetrics provides Prometheus metrics for Runtime SDK extension calls.
//
// Copied from sigs.k8s.io/cluster-api/exp/runtime/metrics (fork-only package).
...
// (e.g. "capi_runtime_sdk") and registers them with the provided
// Prometheus registerer. Callers must invoke this exactly once per
// registerer/subsystem pair.
...
func (m *RequestsTotalObserver) Observe(
	req *http.Request,
	resp *http.Response,
