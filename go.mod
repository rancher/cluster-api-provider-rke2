...
replace (
	sigs.k8s.io/cluster-api => github.com/alexander-demicev/cluster-api v0.0.0-20260326092907-c445c4d8e574
	sigs.k8s.io/cluster-api/test => github.com/alexander-demicev/cluster-api/test v0.0.0-20260326092907-c445c4d8e574
)
