...
var _ = Describe("Workload cluster creation", func() {
	...
	Context("Creating a single control-plane cluster", func() {
		It("Should create a cluster with v0.17.0 and perform upgrade to latest version", func() {
			By("Installing v0.17.0 boostrap/controlplane provider version")
			...
			UpgradeManagementCluster(ctx, clusterctl.UpgradeManagementClusterAndWaitInput{
				ClusterProxy:          bootstrapClusterProxy,
				ClusterctlConfigPath:  clusterctlConfigPath,
				BootstrapProviders:    []string{"rke2-bootstrap:v0.18.99"},
				ControlPlaneProviders: []string{"rke2-control-plane:v0.18.99"},
				LogFolder:             clusterctlLogFolder,
			})
