...
var _ = Describe("Provider upgrade", Label(UpgradeTestsLabel), func() {
	...
	Context("Creating a single control-plane cluster", func() {
		It("Should create a cluster with v0.23.0 and perform upgrade to latest version", func() {
			By("Installing v0.23.0 bootstrap/controlplane provider version")
			...
			UpgradeManagementCluster(ctx, clusterctl.UpgradeManagementClusterAndWaitInput{
				ClusterProxy:            bootstrapClusterProxy,
				ClusterctlConfigPath:    clusterctlConfigPath,
				InfrastructureProviders: []string{"docker:v1.12.7"},
				CoreProvider:            "cluster-api:v1.12.7",
